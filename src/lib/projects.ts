export const projects = [
  ...
  },
  {
    ...
    description:
      "Plataforma digital moderna para gestão de planos de saúde, oferecendo interface intuitiva para usuários e administradores com funcionalidades completas de gerenciamento.",
    image:
  ...
  },
  {
    ...
    description:
      "Landing page e cardapio digital para um restaurante de tapiocas, com design moderno e responsivo, proporcionando uma experiência agradável para os clientes.",
    image:
